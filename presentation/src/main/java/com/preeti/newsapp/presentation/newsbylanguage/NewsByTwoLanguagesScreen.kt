...
@Composable
fun NewsByTwoLanguagesRoute(
    titleAppBar: String = stringResource(R.string.news_by_two_languages),
    onNewsClick: (url: String) -> Unit,
    onBackNavigation: () -> Unit,
    viewModel: NewsByTwoLanguagesViewModel = hiltViewModel(),
    languageId1: String,
    languageId2: String,
) {
    val uiState by viewModel.uiState.collectAsStateWithLifecycle()
    viewModel.fetchNewsByTwoLanguages(languageId1, languageId2)
